...
//           Welcome to <span className="text-blue-800">Avion!</span>
//             </h2>
//             <p className="text-smtext-gray-800 text-center mt-4 leading-relaxed">
            
//             We’re glad to have you here! Please log in to access your account and explore our features.
//             </p>
//             </div>
//             </SignedIn>
...
//             <h2 className="text-gray-800 text-center mt-4  text-2xl font-bold">Sign in</h2>
...
//               <div className=" w-full py-3 px-4 text-sm tracking-wide text-center rounded-lg text-white bg-blue-600 hover:bg-blue-700 ">
          ...
          <div className="p-8 rounded-2xl bg-white shadow">
            ...
            <SignedIn>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-800 text-center mt-4 leading-relaxed">
                  We’re glad to have you here! Please log in to access your account and explore our features.
                </p>
              </div>
            </SignedIn>
